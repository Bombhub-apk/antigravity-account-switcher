(() => {
  ...
  // ==========================================
  // In-Editor Account Switcher & Migration Suite (Ethan Carter)
  // ==========================================
  const SW_I18N = {
    fa: {
      ...
      author: "توسعه داده شده با افتخار توسط Ethan Carter",
    ...
    en: {
      ...
      author: "Developed with precision by Ethan Carter",
      tabProjects: "📁 Projects",
      tabTasks: "⏱ Scheduled Tasks",
    ...
    es: {
      ...
      author: "Desarrollado con precisión por Ethan Carter",
